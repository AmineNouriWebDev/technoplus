                                    ...
                                    <div class="row">
                                     <div class="col-md-12">
                                      <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <textarea name="detail" class="form-control"><?php echo detailfacilitePaiement($_GET['ids']); ?></textarea>
                                        </div>
                                    </div>
                                     </div>
                                    </div>
                                    <div class="row">
                                     <div class="col-md-12">
                                      <div class="form-group">
                                        <h5>Remarque</h5>
                                        <div class="controls">
                                            <input type="text" name="remarque" class="form-control" value="<?php echo rqfacilitePaiement($_GET['ids']); ?>" >
                                        </div>
                                    </div>
                                     </div>
                                    </div>
                                    <div class="row">
                                     <div class="col-md-12">
                                      <div class="form-group">
                                        <h5>Prix</h5>
                                        <div class="controls">
                                            <input type="text" name="prix" class="form-control" value="<?php echo prixfacilitePaiement($_GET['ids']); ?>" >
                                        </div>
                                    </div>
                                     </div>
                                    </div>
