...
?>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Ajouter un point fort</h4>
                                <form method="POST" enctype="multipart/form-data" novalidate="novalidate">
                                    ...
                                    <div class="row">
                                     <div class="col-md-6">
                                      <div class="form-group">
                                        <h5>Icône (code à récupérer <a href="https://icofont.com/icons" target="_blanck">ici</a> </h5>
                                        <div class="controls">
                                    ...
                                    <div class="row">
                                     <div class="col-md-2">
                                      <div class="form-group">
                                        <h5>Ordre</h5>
                                        <div class="controls">
                                            <input type="text" name="ordre" value="<?php echo afficheMaxOrdre('points_forts',1); ?>" class="form-control"> 
                                        </div>
                                    </div>
                                     </div>
                                    </div>
